...
Then a list of triggers should be returned
    */
        ...
        private void StartTestScheduler()
        {
            ...
            // construct job info
            IJobDetail jobDetail = new JobDetail("myJob", null, typeof(sample.scheduler.core.ConsoleJob1));
            // fire every hour
            ITrigger trigger = TriggerUtils.MakeHourlyTrigger();
            // start on the next even hour
            trigger.StartTimeUtc = TriggerUtils.GetEvenHourDate(DateTime.UtcNow);     
            trigger.Key.Name = "myTrigger";
